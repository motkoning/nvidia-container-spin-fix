...
- Run the project's lint and type-check/build commands (from the agent instructions) when
  done, and run the existing tests affected by your change if the agent instructions say how;
  fix your own failures before finishing.
- Do NOT write new tests unless the instruction block explicitly asks — the requester owns
  the testing gate that follows.
...
- lint/build status (and test results, if run)
